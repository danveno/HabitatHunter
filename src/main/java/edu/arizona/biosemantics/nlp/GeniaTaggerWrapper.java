package edu.arizona.biosemantics.nlp;
	...
	public class GeniaTaggerWrapper {
	    ...
	    boolean ascii = true;
	    public GeniaTaggerWrapper(String tagExeFile) {
	        //this(".\\resource\\genia\\geniatagger_win.exe", false); //very slow
	       // this("./resource/genia/geniatagger.exe", false);
	        //this("D:/Program Files/geniatagger301/geniatagger.exe", false);
	        this(tagExeFile, false);
	    ...
	    public static void main(String args[]) {
	        ...
	        GeniaTaggerWrapper server = new GeniaTaggerWrapper(taggerFile);
...
//	            tokens = s.getWords().toArray(tokens);
	            String output[][] = server.doTagging("This is a word".split(" "));
