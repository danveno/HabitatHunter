 ...
 *
 */
public class CompareNotesEHealth
{
...
//        		 System.out.println(e);
  ...
  private static boolean noteMatching(String noteValue1, String noteValue2) {
	  String[] cuis1 = noteValue1.split(" ");	  
	  String[] cuis2 = noteValue1.split(" ");
	  
	  // TODO store into HashSets before parse if risk of a long list of CUIs.
  ...
  private static boolean findNoteMatch (String noteValue, Entity eToCheck, 
      ...
      for (Note n : d.getNotes()) {
		  ...
		  if(entityID.equals(eToCheck.getId())) {
			  return noteMatching(n.getString(), noteValue);
		  }
	  }
	  return false;
  }
